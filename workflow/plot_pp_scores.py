...
if "snakemake" in sys.modules:
    ...
    input_file = (
        "../data/derived/community-detection-datasets/pp/evaluations/all_scores.csv"
    )
    with_legend = True
    params = {
        "dim": 128,
    ...
    q = params["q"]
    output_file_performance = f"../figs/pp_scores_performance_curve_q~{q}.pdf"
    output_file_aucesim = f"../figs/pp_scores_aucroc_tau~{tau}.pdf"
