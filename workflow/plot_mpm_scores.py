...
if "snakemake" in sys.modules:
    ...
    input_file = (
        "../data/derived/community-detection-datasets/mpm/evaluations/all_scores.csv"
    )
    with_legend = True
    params = {
        "dim": 128,
    ...
    q = params["q"]
    output_file_performance = f"../figs/mpm_scores_performance_curve_q~{q}.pdf"
    output_file_aucesim = f"../figs/mpm_scores_aucroc_q~{q}.pdf"
...
ax.axvline(1 - 1.0 / np.sqrt(params["cave"]), color="k", linestyle="dashed")
